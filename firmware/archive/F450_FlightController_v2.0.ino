...
#define PIN_RX_ROLL   2     // INT0
#define PIN_RX_PITCH  3     // INT1
#define PIN_RX_THROT  4
#define PIN_RX_YAW    A2
#define PIN_RX_SW     A3
...
void setup() {
    ...
    if (whoami != 0x68) {
        Serial.print(F("  ERROR: WHO_AM_I=0x"));
        Serial.println(whoami, HEX);
        Serial.println(F("  Check wiring. HALTED."));
        while (1);
    }
...
void loop() {
    ...
    // ── Rotate slow polled channels to spread pulseIn cost
